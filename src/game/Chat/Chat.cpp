...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
		...
		{ MSTR, "gm_ranks",					   SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadGMRanks,						   "", nullptr },
    ...
    static ChatCommand commandTable[] =
    {
		...
		{ NODE, "wannounce",      SEC_BASIC_ADMIN,    true,  &ChatHandler::HandleNameWannounceCommand,       "", nullptr },
