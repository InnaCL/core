...
void MapPersistentStateManager::CleanupInstances()
{
    ...
    _DelHelper(CharacterDatabase, "group_instance.leaderGuid, instance", "group_instance", "LEFT JOIN characters ON group_instance.leaderGuid = characters.guid LEFT JOIN parties ON group_instance.leaderGuid = parties.leaderGuid WHERE characters.guid IS NULL OR parties.leaderGuid IS NULL");
